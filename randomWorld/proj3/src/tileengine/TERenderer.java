...
public class TERenderer {
    ...
    public void renderFrame(TETile[][] world, Point pos, double sightRange) {
        int numXTiles = world.length;
        int numYTiles = world[0].length;
        StdDraw.clear(new Color(0, 0, 0));
        for (int x = 0; x < numXTiles; x += 1) {
            for (int y = 0; y < numYTiles; y += 1) {
                ...
                if(pos.distance(x, y) < sightRange) {
                    world[x][y].draw(x + xOffset, y + yOffset);
                    continue;
                }
...
//                world[x][y].draw(x + xOffset, y + yOffset);
    ...
    private Point convertMouseToTileCoordinates(Point mousePoint) {
        // Implement conversion logic here
        int tileX = mousePoint.x / TILE_SIZE;
        int tileY = mousePoint.y / TILE_SIZE;
        return new Point(tileX, tileY);
    }

//    public TETile[][] renderFrame(TETile[][] world, Point pos, double sightRange) {
////        TETile[][] temp = world;
//
//        TETile[][] temp = new TETile[world.length][];
